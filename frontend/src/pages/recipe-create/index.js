...
const RecipeCreate = ({ onEdit }) => {
  ...
  return <Main>
    <Container>
      <MetaTags>
        <title>Создание рецепта коктейля</title>
        <meta name="description" content="Коктейли" />
        <meta property="og:title" content="Создание рецепта коктейля" />
      </MetaTags>
      <Title title='Создание рецепта коктейля' />
      <Form
